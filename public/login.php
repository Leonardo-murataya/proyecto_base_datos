...
<body>
    <h1 class="animate__animated animate__fadeInDown">Iniciar Sesión en la Base de Datos</h1>
    <form method="post" action="login.php" class="animate__animated animate__fadeInUp">
        <div class="form-group">
            ...
            <select id="db_type" name="db_type" class="form-control" onchange="autocompletePort()" required>
        ...
        <div class="form-group">
            ...
            <input type="text" id="db" name="db" class="form-control" required>
        </div>
        <div class="form-group">
