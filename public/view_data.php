...
<div class="view-data-container">
    ...
    <nav>
        <a class="links" href="add_data.php">Agregar Nuevo Registro</a>
    </nav>

    <form class="formTables view-data-form" method="get" action="view_data.php">
    ...
    <form class="formTables view-data-form" method="post" action="view_data.php">
    ...
    <?php if ($message): ?>
        <p class="view-data-message"><?php echo htmlspecialchars($message); ?></p>
    <?php endif; ?>

    <?php if ($custom_query_result): ?>
        <h2>Resultados de la Consulta Personalizada</h2>
        <table class="custom-query-table">
            <thead>
            <tr>
                <th>#</th>
